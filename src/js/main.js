...
let betrag_1 = parseInt(prompt("Betrag (in Cent):")); //parseInt wandelt string in Number!
...
let betrag_2 = parseInt(prompt("Betrag (in Cent):")); //parseInt wandelt string in Number!
